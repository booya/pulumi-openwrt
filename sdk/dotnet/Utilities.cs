...
namespace Pulumi.Openwrt
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Openwrt.version.txt");
    ...
    internal sealed class OpenwrtResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public OpenwrtResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
